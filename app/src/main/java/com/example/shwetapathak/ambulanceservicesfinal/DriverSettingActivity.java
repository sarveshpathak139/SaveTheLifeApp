...
public class DriverSettingActivity extends AppCompatActivity {
    ...
    private EditText mnamefield,mcontactfield,typeofambulance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeofambulance = (EditText)findViewById(R.id.typeofambulance);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(Map.get("typeofambulance")!=null){
                        ambulancefield = Map.get("typeofambulance").toString();
                        typeofambulance.setText(ambulancefield);
    ...
    private void saveuserinfo() {
        ...
        ambulancefield = typeofambulance.getText().toString();
